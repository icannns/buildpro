...
const sqlCommands = `
    ...
    INSERT INTO materials (id, name, category, unit, stock, price, status) VALUES
    (1, 'Semen Portland', 'Material Dasar', 'sak', 5, 85000, 'Low Stock'),
    (2, 'Pasir Beton', 'Material Dasar', 'm3', 10, 300000, 'Low Stock'),
    (3, 'Besi Beton 10mm', 'Material Struktur', 'batang', 100, 65000, 'In Stock');

    -- 5. SETUP PROJECT
    DELETE FROM projects;
    INSERT INTO projects (id, name, status, start_date, budget) VALUES
    (1, 'Pembangunan Villa Bali', 'In Progress', CURDATE(), 1500000000);
    ...
    INSERT INTO payment_terms (project_id, termin_name, milestone_percentage, amount, status, due_date) VALUES
    (1, 'Down Payment (DP)', 20.00, 300000000, 'Paid', CURDATE()),
    (1, 'Termin 1 (Pondasi Selesai)', 30.00, 450000000, 'Pending', DATE_ADD(CURDATE(), INTERVAL 1 MONTH)),
    (1, 'Termin 2 (Struktur Atap)', 40.00, 600000000, 'Pending', DATE_ADD(CURDATE(), INTERVAL 3 MONTH)),
    (1, 'Retensi (Serah Terima)', 10.00, 150000000, 'Pending', DATE_ADD(CURDATE(), INTERVAL 6 MONTH));
